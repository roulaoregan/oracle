...
class OracleClassifier(object):
	...
	def train(self):
		...
		#use [:punct:] instead of special chars
...
def main():
	...
	genesis_text = "The path of the righteous man is beset on all sides by the inequities of the selfish and \
			the tyranny of evil men. Blessed is he who, in the name of charity and good will, shepherds \
			the weak through the valley of the darkness, for he is truly his brother's keeper and the finder \
